    ...
    <div className="container py-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p>
            This Cookies Policy explains how BayriKo ("we", "us", or "our") uses
            cookies and similar technologies to recognize you when you visit our
            website and application. It explains what these technologies are and
        ...
        <section className="space-y-4">
          ...
          <p className="mt-4">
            Cookies set by the website owner (in this case, BayriKo) are called
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              ...
              our website and application. They include, for example, cookies
              that enable you to log into secure areas.
            </li>
            <li>
              <strong>Functionality cookies:</strong> Allow us to remember
              choices you have made and provide enhanced, personalized features.
            </li>
            <li>
              <strong>Performance/Analytics cookies:</strong> Collect
              information about how visitors use our website, which pages they
              visit, and if they experience any errors. These cookies do not
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Session cookies:</strong> Used to maintain your session
              and authentication state while using our application.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Preference cookies:</strong> Store your preferences, such
              as language and display settings.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Google Analytics:</strong> Collects anonymous information
              about how you use our site to help us improve its functionality
              and user experience.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="mt-4">
            The specific way to refuse cookies through your web browser controls
            varies from browser to browser. You should visit your browser's help
            menu for more information.
          </p>
          <p className="mt-4">
            Here are links to instructions for managing cookies in some popular
            browsers:
          </p>
          <ul className="list-disc pl-5 space-y-2">
            <li>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            on. These cookies may be placed when you interact with services we
            use, such as social media sites, analytics services, and advertising
            networks.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            tracked. Our website does not currently respond to "Do Not Track"
            signals.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            your continued use of our services following these changes means
            that you accept the revised Cookie Policy.
          </p>
        </section>
