...
export default function TaskPayablePage() {
  ...
  const handleDownloadPDF = () => {
    ...
    // Create a simple text-based logo instead of using an image
    const logoY = footerY - 20; // Position logo above footer text
    
    // Set up text logo properties
    // This avoids CORS issues and ensures the image will always load
    const bayriko_logo_base64 =
