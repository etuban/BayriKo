    ...
    <div className="container py-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p>
            BayriKo ("we", "us", or "our") respects your privacy and is
            ...
            our website and use our services, and tell you about your privacy
            rights and how the law protects you.
          </p>
          <p>
            This privacy policy applies to all users of our task management
            platform.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            Includes first name, last name, username, password, or similar
            identifier.
          </p>
          ...
          <p>
            ...
            such as task creation, project management activities, and user
            interactions.
          </p>

          <h3 className="text-xl font-medium mt-6">Organization Data</h3>
          <p>
            Includes information about your organization, projects, and team
            members that you provide to us when using our services.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              ...
              Identity, Contact, and Organization Data by filling in forms or by
            ...
            <li>
              ...
              you from various third parties, such as analytics providers,
              authentication providers (like Google), and other technical
              service providers.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Service providers:</strong> who provide IT and system
            ...
            <li>
              <strong>Authorities:</strong> such as regulators and other
              authorities who require reporting of processing activities in
              certain circumstances.
            </li>
            <li>
              <strong>Third parties:</strong> to whom we may choose to sell,
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              <strong>Request restriction of processing</strong> your personal
              data.
            </li>
            <li>
            ...
            <li>
              <strong>Right to withdraw consent</strong> where we are relying on
