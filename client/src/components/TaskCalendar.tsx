          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  className="text-xs text-primary hover:text-primary/90 ml-1 flex items-center gap-1"
                  onClick={(e) => {
                    e.stopPropagation();
                    navigate(`/tasks/${task.id}`);
                  }}
              ...
              <TooltipContent side="right" className="task-tooltip-content">
        ...
        {currentView === "month" ? (
          ...
          <>
            ...
            {timeSlots.map((hour) => (
              <div
                key={hour}
                className="grid grid-cols-8 border-b border-dark-border min-h-[60px]"
              >
                {/* Time Column */}
                  ...
                  >
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            Add task at {hour <= 12 ? hour : hour - 12}:00{" "}
                            {hour < 12 ? "AM" : "PM"}
                          </p>
                        </TooltipContent>
                      </Tooltip>
